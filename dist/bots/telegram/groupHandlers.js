...
exports.handleGroupInfo = exports.handleNewChatMembers = void 0;
const BOT_TOKEN = process.env.TELEGRAM_BOT_TOKEN;
const handleNewChatMembers = async (bot, msg) => {
    const chatId = msg.chat.id;
    await sendGroupInfo(bot, chatId);
};
exports.handleNewChatMembers = handleNewChatMembers;
const handleGroupInfo = async (bot, msg) => {
    const chatId = msg.chat.id;
    await sendGroupInfo(bot, chatId);
};
exports.handleGroupInfo = handleGroupInfo;
const sendGroupInfo = async (bot, chatId) => {
    try {
